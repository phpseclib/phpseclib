...
class SSH2
{
     ...
     */
    public static function setCryptoEngine(int $engine)
    {
     ...
     */
    private function encryption_algorithm_to_key_size(string $algorithm)
    {
     ...
     */
    private static function mac_algorithm_to_hash_instance(string $algorithm)
    {
        switch ($algorithm) {
     ...
     */
    public function setKeepAlive(int $interval)
    {
     ...
     * @see self::_get_binary_packet()
     */
    protected function send_binary_packet(string $data, string $logged = null)
    {
        if (!is_resource($this->fsock) || feof($this->fsock)) {
            $this->bitmap = 0;
     ...
     * @return void
     */
    protected function send_channel_packet(int $client_channel, string $data)
    {
        while (strlen($data)) {
     ...
     * @return void
     */
    private function close_channel(int $client_channel, bool $want_reply = false)
    {
     ...
     */
    public function setTerminal(string $term)
    {
        $this->term = $term;
    }
     ...
     */
    public function setWindowColumns(int $value)
    {
     ...
     */
    public function setWindowRows(int $value)
    {
     ...
     */
    public function setWindowSize(int $columns = 80, int $rows = 24)
    {
     ...
     */
    private function updateLogHistory(string $old, string $new)
    {
