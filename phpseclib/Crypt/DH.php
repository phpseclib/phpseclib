...
abstract class DH extends AsymmetricKey
{
    ...
    public static function createParameters(BigInteger|int|string ...$args): Parameters
    {
        ...
        $prime = match ($args[0]) {
            ...
            // see http://tools.ietf.org/html/rfc3526#section-3, 2048-bit MODP Group
            ...
            // see https://tools.ietf.org/html/rfc3526#section-4, 3072-bit MODP Group
            ...
            // see https://tools.ietf.org/html/rfc3526#section-5, 4096-bit MODP Group
            ...
            // see https://tools.ietf.org/html/rfc3526#section-6, 6144-bit MODP Group
            ...
            // see https://tools.ietf.org/html/rfc3526#section-7, 8192-bit MODP Group
