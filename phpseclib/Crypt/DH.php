...
abstract class DH extends AsymmetricKey
{
    ...
    public static function createParameters(...$args): Parameters
    {
        ...
        if (count($args) == 2 && $args[0] instanceof BigInteger && $args[1] instanceof BigInteger) {
            ...
            throw new \phpseclib3\Exception\InvalidArgumentException('Valid parameters are either: two BigInteger\'s (prime and base), a single integer (the length of the prime; base is assumed to be 2) or a string');
        }
        switch ($args[0]) {
            ...
            case 'diffie-hellman-group18-sha512': // 8192-bit MODP Group
                ...
                break;
            default:
                throw new \phpseclib3\Exception\InvalidArgumentException('Invalid named prime provided');
        }
            ...
            switch (true) {
                case $public instanceof PublicKey:
                    if (!$private->prime->equals($public->prime) || !$private->base->equals($public->base)) {
                        throw new \phpseclib3\Exception\InvalidArgumentException('The public and private key do not share the same prime and / or base numbers');
                    }
                ...
                default:
                    throw new \phpseclib3\Exception\InvalidArgumentException('$public needs to be an instance of DH\PublicKey, a BigInteger or a string');
            }
        }
            ...
            switch (true) {
                ...
                case is_string($public):
                    ...
                    */
                    return $secret;
                default:
                    throw new \phpseclib3\Exception\InvalidArgumentException('$public needs to be an instance of EC\PublicKey or a string (an encoded coordinate)');
            }
        }
    }
