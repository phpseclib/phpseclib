...
class Crypt_Base
{
    ...
    */
     ...
     * - self::MODE_OPENSSL  (very fast, php-extension: openssl, extension_loaded('openssl') required)
     *
    ...
    function __construct($mode = self::MODE_CBC)
    {
        ...
        if (!defined('CRYPT_ENGINE')) {
            switch (true) {
                case extension_loaded('mcrypt') && in_array($this->cipher_name_mcrypt, mcrypt_list_algorithms()):
                    define('CRYPT_ENGINE', self::ENGINE_MCRYPT);
                    break;
                default:
                    define('CRYPT_ENGINE', self::ENGINE_INTERNAL);
            }
        }
        ...
        switch (true) {
            case empty($this->cipher_name_mcrypt): // The cipher module has no mcrypt-engine support at all so we force self::ENGINE_INTERNAL
                ...
                break;
            case CRYPT_ENGINE == self::ENGINE_MCRYPT:
