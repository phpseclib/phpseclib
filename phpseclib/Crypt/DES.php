...
class DES extends BlockCipher
{
     ...
     * @see self::setKey()
     */
    protected int $key_length_max = 8;
     ...
     * @var string[]
     */
    protected static array $shuffle = [
     ...
     * @var int[]
     */
    protected static array $invipmap = [
