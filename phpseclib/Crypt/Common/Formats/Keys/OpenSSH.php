...
abstract class OpenSSH
{
     ...
     */
    public static function setBinaryOutput(bool $enabled)
    {
        self::$binary = $enabled;
    }
     ...
     */
    private static function checkType(string $candidate)
    {
     ...
     */
    protected static function wrapPrivateKey(string $publicKey, string $privateKey, string $password, array $options): string
    {
