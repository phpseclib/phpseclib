...
class PrivateKey extends RSA implements Common\PrivateKey
{
    ...
    public function toString(string $type, array $options = []): string
    {
        ...
        return $type::savePrivateKey($this->modulus, $this->publicExponent, $this->exponent, $this->primes, $this->exponents, $this->coefficients, $this->password === false ? '' : $this->password, $options);
